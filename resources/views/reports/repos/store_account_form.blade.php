...
@section('page_name')
    المحلات <i class="fa-solid fa-shop"></i>
@endsection
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">كشف حساب المحل</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="{{route('reports.store_account', auth()->user()->id)}}" method="GET" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    @error('store')
                        <label class="text-danger">{{ $message }}</label><br>
                    @enderror
                    <select class="js-example-basic-single" style="width: 100%" name="store">
                        @foreach ($store as $r)
