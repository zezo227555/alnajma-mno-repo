...
@section('page_name')
    المستخدمين <i class="fa-solid fa-users"></i>
@endsection
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">اضافات المشرف</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="{{route('reports.admin_adds_to_repo', auth()->user()->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
