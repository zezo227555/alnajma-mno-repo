...
@section('page_content')
    <div class="card">
        ...
        <div class="card card-primary card-outline px-5 py-2">
            <form action="{{route('reports.repo.edit_store_dissmisal_deposet', $recipt->id)}}" method="POST">
                @csrf
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" value="{{$recipt->ammount}}" step="1" min="0" name="ammount" class="form-control">
                ...
                <div class="form-group">
                    ...
                    @error('info')
                        <label class="text-danger">{{ $message }}</label><br>
                    @enderror
                    <textarea class="form-control" name="info" rows="3" placeholder="اكتب وصفا للأيصال">{{$recipt->info}}</textarea>
                </div>
                    <div class="row">
                    <!-- /.col -->
                    <div class="col-12">
...
@error('low_balance')
  <script>
      function massge() {
          ...
          position: 'top-end',
          icon: 'error',
          title: "{{ $errors->first('low_balance') }}",
          showConfirmButton: false,
          timer: 1500
      })
  }
