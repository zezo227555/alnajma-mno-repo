...
@section('page_content')
    <div class="card">
        ...
        <h3 class="card-title">تعديل ايصال للمشرف </h3>
        <button type="button" class="btn btn-block btn-info btn-sm w-25">دين المشرف  {{$user->balance}}</button>
        </div>
        <div class="card card-primary card-outline px-5 py-2">
            <form action="{{route('reports.alnajma.edit_admin_dissmisal', $deposet_dissmisal->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
