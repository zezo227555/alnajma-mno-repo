...
@section('page_name')
    ايصال صرف <i class="fa-solid fa-money-bill-transfer"></i>
@endsection

@section('page_content')
    <div class="card">
        <div class="card-header">
        <h3 class="card-title">اضافة ايصال صرف للمحل <span class="btn btn-danger">{{$store->name}} <i class="fa-solid fa-shop"></i></span></h3>
        ...
        <div class="card card-primary card-outline px-5 py-2">
            <form action="{{route('store.store_dissmisal', $store->id)}}" method="POST">
                @csrf
                ...
                <div class="input-group mb-3">
                    ...
                    <input value="{{old('ammount')}}" type="number" step="1" min="0" name="ammount" class="form-control">
